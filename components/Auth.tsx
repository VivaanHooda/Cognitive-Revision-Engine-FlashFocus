...
import { Loader2, Mail, Lock, User as UserIcon, ArrowRight, Brain } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">FlashFocus</h1>
          <p className="text-slate-500 mt-2 font-medium">Your second brain for spatial mastery.</p>
        </div>
