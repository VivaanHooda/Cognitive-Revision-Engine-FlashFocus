...
(() => {
var exports = {};
exports.id = "app/api/gemini/clarify/route";
exports.ids = ["app/api/gemini/clarify/route"];
exports.modules = {

/***/ "(rsc)/./app/api/gemini/clarify/route.ts":
/*!*****************************************!*\
  !*** ./app/api/gemini/clarify/route.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_gemini_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/gemini.server */ \"(rsc)/./lib/gemini.server.ts\");\n\n\nasync function POST(req) {\n    try {\n        const { question, cardFront, cardBack, history } = await req.json();\n        if (!question || !cardFront || !cardBack) return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"Missing parameters\"\n        }, {\n            status: 400\n        });\n        const answer = await (0,_lib_gemini_server__WEBPACK_IMPORTED_MODULE_1__.askCardClarification)(question, cardFront, cardBack, history || []);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            answer\n        });\n    } catch (err) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: err.message || \"Server error\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/gemini/clarify/route.ts\n");
